...
interface FooterSectionProps {
  onMarketplaceClick?: (platform: 'lazada' | 'shopee' | 'tiktok_shop') => void;
  onSocialClick?: (platform: 'instagram' | 'facebook' | 'tiktok') => void;
  onBackToTop?: () => void;
}

export default function FooterSection({ onMarketplaceClick, onSocialClick, onBackToTop }: FooterSectionProps) {
  return (
        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6 lg:gap-0">
          ...
          <div className="flex flex-col max-w-sm">
            ...
            <div className="flex items-center gap-5">
              <a href="https://www.lazada.co.id/products/sandisk-phone-drive-for-android-usb-type-a-dan-otg-type-c-i8265588670-s14676420564.html" target="_blank" rel="noopener noreferrer" onClick={() => onMarketplaceClick?.('lazada')}>
                <Image src="/images/lazada-market.png" alt="Lazada" width={80} height={28} className="h-7 w-auto object-contain" />
              </a>
              <a href="https://shopee.co.id/SANDISK-Phone-Drive-for-Android-USB-Type-C-A-32GB-64GB-128GB-256GB-512GB-USB-3.2-Up-To-100MB-s-i.1657263.24536652989" target="_blank" rel="noopener noreferrer" onClick={() => onMarketplaceClick?.('shopee')}>
                <Image src="/images/shopee-market.png" alt="Shopee" width={80} height={28} className="h-7 w-auto object-contain" />
              </a>
              <a href="https://vt.tokopedia.com/t/ZS91fMe6Xyvhb-TXgeb/" target="_blank" rel="noopener noreferrer" onClick={() => onMarketplaceClick?.('tiktok_shop')}>
          ...
          <div className="flex items-center gap-5">
            ...
            <div className="flex items-center gap-4">
              <a href="https://www.instagram.com/sandiskindonesia/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" onClick={() => onSocialClick?.('instagram')}>
              ...
              <a href="https://www.facebook.com/SanDiskIndonesia" target="_blank" rel="noopener noreferrer" aria-label="Facebook" onClick={() => onSocialClick?.('facebook')}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-6 h-6 fill-white hover:fill-brand-red transition-colors">
                  <path d="M24 12.073C24 5.405 18.627 0 12 0S0 5.405 0 12.073C0 18.1 4.388 23.094 10.125 24v-8.437H7.078v-3.49h3.047V9.413c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.49h-2.796V24C19.612 23.094 24 18.1 24 12.073z"/>
                </svg>
              </a>
              <a href="https://www.tiktok.com/@sandiskindonesia" target="_blank" rel="noopener noreferrer" aria-label="TikTok" onClick={() => onSocialClick?.('tiktok')}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-6 h-6 fill-white hover:fill-brand-red transition-colors">
