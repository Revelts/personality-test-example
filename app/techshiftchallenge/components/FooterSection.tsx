  ...
  return (
    <>
      ...
      <footer ref={footerRef} className="bg-white">
        ...
        <div className="px-6 lg:px-16 py-8 lg:py-10">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 lg:gap-0">
              ...
              <div className="flex items-center gap-5 lg:gap-8">
                <Image
                  ...
                  width={120}
                  height={32}
                  className="object-contain lg:w-[150px]"
                />
                ...
                <div className="flex items-center gap-4 lg:gap-5">
                  <a href="https://www.instagram.com/sandiskid" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-6 h-6 lg:w-7 lg:h-7 fill-black hover:fill-brand-red transition-colors">
              ...
              <div className="flex flex-col lg:items-end gap-2">
                ...
                <p className="text-xs text-black/40">© 2026 SanDisk. All rights reserved.</p>
              </div>
            </div>
