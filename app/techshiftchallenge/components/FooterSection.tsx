        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6 lg:gap-0">
          ...
          <div className="flex flex-col max-w-sm">
            ...
            <div className="flex items-center gap-5">
              <a href="https://www.lazada.co.id/products/sandisk-phone-drive-for-android-usb-type-a-dan-otg-type-c-i8265588670-s14676420564.html" target="_blank" rel="noopener noreferrer">
                <Image src="/images/lazada-market.png" alt="Lazada" width={80} height={28} className="h-7 w-auto object-contain" />
              </a>
              <a href="https://shopee.co.id/SANDISK-Phone-Drive-for-Android-USB-Type-C-A-32GB-64GB-128GB-256GB-512GB-USB-3.2-Up-To-100MB-s-i.1657263.24536652989" target="_blank" rel="noopener noreferrer">
                <Image src="/images/shopee-market.png" alt="Shopee" width={80} height={28} className="h-7 w-auto object-contain" />
              </a>
              <a href="https://vt.tokopedia.com/t/ZS91fMe6Xyvhb-TXgeb/" target="_blank" rel="noopener noreferrer">
          ...
          <div className="flex items-center gap-5">
            ...
            <div className="flex items-center gap-4">
              <a href="https://www.instagram.com/sandiskindonesia/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
              ...
              <a href="https://www.facebook.com/SanDiskIndonesia" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-6 h-6 fill-white hover:fill-brand-red transition-colors">
