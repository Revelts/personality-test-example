    ...
    <AnimatePresence>
      ...
      >
        ...
        <div className="relative z-10 text-center px-4 w-full max-w-md mx-auto">
          {/* Animation Container - Vertical: Phone on top, USB animates from below */}
          <div className="mb-8 sm:mb-12 flex flex-col items-center">
            ...
            >
              ...
              >
                ...
                {stage === 'connected' && (
                  ...
                  >
                    <div className="bg-green-500 rounded-full w-12 h-12 flex items-center justify-center shadow-2xl">
                ...
                {/* Port glow at bottom */}
                <motion.div
                  className="absolute bottom-1 left-1/2 -translate-x-1/2 w-6 h-2 bg-brand-red rounded-full blur-md"
                  animate={{
                    opacity: stage === 'plugging' ? [0.3, 0.8, 0.3] : stage === 'connected' ? 1 : 0,
                  }}
                  transition={{ duration: 0.8, repeat: stage === 'plugging' ? Infinity : 0 }}
                />
              </motion.div>
            ...
            {/* USB Icon - starts below, animates up to phone's port */}
            <motion.div
            ...
            >
              <div className="w-16 h-16 relative -rotate-90 translate-x-3">
                <Image
                  src="/images/usbc.png"
                  alt="USB"
                  fill
                ...
                <motion.div
                  ...
                  animate={{
                    backgroundColor: stage === 'connected'
                      ? '#4CAF50'
                  ...
                  transition={{ duration: 1, repeat: stage === 'plugging' ? Infinity : 0 }}
                />
              </div>

              {/* Data Transfer Particles - float upward toward phone */}
              {stage === 'plugging' && (
                <motion.div
